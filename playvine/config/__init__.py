...
from playvine.objects.vaults import Vault
from playvine.utils.collections import merge_dict
...
class Directories:
    def __init__(self):
        self.app_dirs = AppDirs("playvine", False)
...
from playvine.services import SERVICE_MAP  # noqa: E402
