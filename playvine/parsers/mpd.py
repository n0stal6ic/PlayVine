...
def parse(*, url=None, data=None, source, session=None, downloader=None):
        ...
        for adaptation_set in period.findall("AdaptationSet"):
            ...
            for rep in adaptation_set.findall("Representation"):
                ...
                for protection in protections:
                    # (HMAX) the PSSH has multiple keys but the PlayReady ContentProtection tag contains the correct KID
                    if not kid:
                ...
                if rep_base_url:
                    # This mpd allows us to download the entire file in one go without segmentation
    ...
    # Since the custom track id above uses all kinds of data, there realistically would be no other workaround.
    tracks_obj = Tracks()
